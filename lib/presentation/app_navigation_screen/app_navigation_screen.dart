                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            _buildScreenTitle(
                              context,
                              welcomeText: "Splash ".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.splashScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Welcome".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.welcomeScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Sign Up".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.signUpScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Login".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.loginScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Vefification Code".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.vefificationCodeScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Resset Password".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.ressetPasswordScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Phone Registration".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.phoneRegistrationScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Side Menu".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.sideMenuScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Home Screen - Container".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.homeScreenContainerScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Food Details".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.foodDetailsScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Category".tr,
                              onTapScreenTitle: () =>
                            ...
                            _buildScreenTitle(
                              context,
                              welcomeText:
                                  "My Orders Upcoming - Tab Container".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                            ...
                            _buildScreenTitle(
                              context,
                              welcomeText:
                                  "Favorites Food Items - Tab Container".tr,
                              onTapScreenTitle: () => onTapScreenTitle(AppRoutes
                                  .favoritesFoodItemsTabContainerScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Profile".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.profileScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Add new address".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.addNewAddressScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Rating".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.ratingScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Reviews".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.reviewsScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              welcomeText: "Review Resturent".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.reviewResturentScreen),
                            ),
                          ],
                        ),
                      ),
